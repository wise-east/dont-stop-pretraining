...
# baseline 
sbatch -J chemprot submit_task_finetune.sh chemprot roberta-base
sbatch -J rct-20k submit_task_finetune.sh rct-20k roberta-base

sbatch -J cintent submit_task_finetune.sh citation_intent roberta-base
sbatch -J sciie submit_task_finetune.sh sciie roberta-base
